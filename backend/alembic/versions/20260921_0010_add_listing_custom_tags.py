...
def downgrade() -> None:
    op.drop_index("ix_product_custom_tag_assignments_tag", table_name="product_custom_tag_assignments")
    op.drop_index("ix_product_custom_tag_assignments_item", table_name="product_custom_tag_assignments")
