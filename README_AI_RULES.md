...
这是本项目的 AI 开发规则包。它用于约束任何 AI 开发助手在本项目中的行为，避免多人、多 AI 协作时出现乱改代码、乱选技术栈、复制旧系统代码、缺少注释、接口不统一、PR 难审查等问题。
...
3. `docs/PROJECT_BOOTSTRAP_RULES.md`
...
9. `docs/BACKGROUND_TASK_DEVELOPMENT_RULES.md`

## 给团队的统一要求

任何人使用 AI 开发时，都必须要求 AI 先读取项目规则。可以复制以下启动提示词：
