# 查询本地产品详情 — Redacted Contract Snapshot

| Item | Evidence |
|---|---|
| Interface key | `LX-DCB0C142100B` |
| Contract status | `READY_FOR_PRP` |
| Source document | `old-system/source/docs/lingxing/ProductDetails.md` |
| Normalized interface source | `docs/integrations/lingxing-walmart-openapi/normalized/interfaces.csv#LX-DCB0C142100B` |
| Path | `/erp/sc/routing/data/local_inventory/productInfo` |
| Method | `POST` |
| Protocol | `HTTPS` |
| Pagination | `无` |
...
Source: `docs/integrations/lingxing-walmart-openapi/normalized/request_params.csv#LX-DCB0C142100B (3 rows)`

| Path | Name | Type | Required |
|---|---|---|---|
| `id` | `id` | `int` | `否` |
| `sku` | `sku` | `string` | `否` |
| `sku_identifier` | `sku_identifier` | `string` | `否` |


## Response fields

Source: `docs/integrations/lingxing-walmart-openapi/normalized/response_fields.csv#LX-DCB0C142100B (132 rows)`
...
| `data.aux_relation_list` | `aux_relation_list` | `array` | `是` |
| `data.aux_relation_list[].aux_name` | `aux_name` | `string` | `是` |
| `data.aux_relation_list[].aux_qty` | `aux_qty` | `string` | `是` |
| `data.aux_relation_list[].aux_sku` | `aux_sku` | `string` | `是` |
| `data.aux_relation_list[].sku_qty` | `sku_qty` | `string` | `是` |
...
| `data.category_full_name` | `category_full_name` | `string` | `是` |
...
| `data.clearance.customs_clearance_price` | `customs_clearance_price` | `string` | `是` |
...
| `data.declaration.customs_import_price` | `customs_import_price` | `string` | `否` |
| `data.declaration.customs_import_price_currency` | `customs_import_price_currency` | `string` | `否` |
...
| `data.qc_standard.custom_qc_template` | `custom_qc_template` | `object` | `否` |
| `data.qc_standard.custom_qc_template.qc_image` | `qc_image` | `array` | `是` |
| `data.qc_standard.custom_qc_template.qc_image[].customer_url` | `customer_url` | `string` | `否` |
| `data.qc_standard.custom_qc_template.qc_image[].file_id` | `file_id` | `int` | `否` |
| `data.qc_standard.custom_qc_template.qc_images` | `qc_images` | `array` | `是` |
| `data.qc_standard.custom_qc_template.qc_images[].file_id` | `file_id` | `string` | `是` |
...
| `data.supplier_quote[].quote_cg_delivery` | `quote_cg_delivery` | `int` | `是` |
...
| `data.supplier_quote[].quotes.tax_rate` | `tax_rate` | `string` | `是` |
